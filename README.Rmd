...
Computes the mean incidence, upper confidence interval, and p-value with multiple key informants for complete graphs and chain bipartite graphs. For more details, see help (de.sq).
...
result <- directEffects(CE = CE, thr = 0.5, reps = 1000, delete = TRUE)
```
